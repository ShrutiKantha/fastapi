class monaimodel:
    ...
    # Import the necessary transformations from the MONAI library
        ...
        model.load_state_dict(torch.load("C://Users//kanth//OneDrive//Desktop//3dVRRadiology//The Fast API App//The Fast API App//best_metric_model.pth", map_location=torch.device('cpu')))
